...
if __name__ == '__main__':
    ...
    if args.arch == "r18" :
        ...
        net = ab1res100net20(h=args.h, b1=args.b1)
    elif args.arch=="100ab1r32" :
        net = ab1res100net32(h=args.h, b1=args.b1)
    elif args.arch=="100ab1r44" :
        net = ab1res100net44(h=args.h, b1=args.b1)
    elif args.arch=="100ab1r56" :
        net = ab1res100net56(h=args.h, b1=args.b1)
    elif args.arch=="100ab1r98" :
        net = ab1res100net98(h=args.h, b1=args.b1)
    elif args.arch=="100ab1r104" :
        net = ab1res100net104(h=args.h, b1=args.b1)
    elif args.arch=="100ab1r110" :
        net = ab1res100net110(h=args.h, b1=args.b1)
    elif args.arch=="100ab1r116" :
        net = ab1res100net116(h=args.h, b1=args.b1)
    elif args.arch=="100ab1r122" :
        net = ab1res100net122(h=args.h, b1=args.b1)
    elif args.arch=="100ab1r128" :
        net = ab1res100net128(h=args.h, b1=args.b1)
    elif args.arch=="100ab1r134" :
        net = ab1res100net134(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r140" :
        net = ab1res100net140(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r146" :
        net = ab1res100net146(h=args.h,b1=args.b1)        
    elif args.arch=="100ab1r152" :
        net = ab1res100net152(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r158" :
        net = ab1res100net158(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r164" :
        net = ab1res100net164(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r170" :
        net = ab1res100net170(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r176" :
        net = ab1res100net176(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r182" :
        net = ab1res100net182(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r188" :
        net = ab1res100net188(h=args.h,b1=args.b1)   
    elif args.arch=="100ab1r218" :
        net = ab1res100net218(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r248" :
        net = ab1res100net248(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r278" :
        net = ab1res100net278(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r308" :
        net = ab1res100net308(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r338" :
        net = ab1res100net338(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r368" :
        net = ab1res100net368(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r398" :
        net = ab1res100net398(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r428" :
        net = ab1res100net428(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r458" :
        net = ab1res100net458(h=args.h,b1=args.b1)
    elif args.arch=="100ab1r488" :
        net = ab1res100net488(h=args.h,b1=args.b1)
...
#            train_scheduler.step(epoch)
    ...
    '''不同h-res100net110'''
    rowqc=(args.tao*10)+int(args.h*10)
    colqc=args.repnum+3
    from openpyxl import load_workbook
    wb = load_workbook(r'log/12.22/12.22.xlsx')
    sheet = wb.active
    sheet.cell(row=rowqc, column=colqc).value = test_top1_acc.item()
    coltem=colqc+7
    sheet.cell(row=rowqc, column=coltem).value = train_top1_acc.item()
    wb.save(r'log/12.22/12.22.xlsx')
    print("运行结束！")
    print("0.3-4.5")
